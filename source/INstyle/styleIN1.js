...
function Sa(r) { //footer
    let e, i = `<div class="items-center grid-flow-col">
                    <img width="24" height="24" src="mainlogo.png" alt="Sahanlogo"/>
                </div> 
                <div class="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
                    <a href="mailto:sahanjay31@gmail.com">
                    ...
                    <a href="https://t.me/Sahanwickramasinghe">
                    ...
                    <a href="./subINDEX/proof.index.html">
                    <button onclick="alert('ENTER SAHANA Proof section')" class="bg-blue-500 text-white px-4 py-2 rounded">Click Here</button>
                    </a>
                </div>`;
